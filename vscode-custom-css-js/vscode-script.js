document.addEventListener("DOMContentLoaded", function () {
  const checkElement = setInterval(() => {
    ...
    // update the vim mode in the title bar
    const sourceElement = document.getElementById("vscodevim.vim.primary");
    const targetElement = document.querySelector(".titlebar-left");
    targetElement.innerText = sourceElement.ariaLabel;
